...
var _default = function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        EmojiPickerWrapper,
        { className: 'ld-emoji-picker-wrapper-outer' },
        this.renderTabs(),
        _react2.default.createElement(
          CloseWrapper,
          { className: 'ld-emoji-button-close-wrapper', onClick: this.props.closeModal },
          _react2.default.createElement(
            Close,
            { width: '24', height: '24', viewBox: '0 0 24 24', className: 'ld-emoji-button-close' },
            _react2.default.createElement(
              'g',
        ...
        _react2.default.createElement(
          EmojiWrapper,
          { className: 'ld-emoji-picker-wrapper' },
